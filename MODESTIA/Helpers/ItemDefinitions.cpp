...
const std::map<size_t, CWeaponInfo> WeaponInformations =
{
...
const std::vector<CWeaponName> KnifeNames =
{
	{0, "Default"},
	...
	{WEAPON_KNIFE_PUSH, "Shadow Daggers Knife"},
...
const std::vector<CWeaponName> GloveNames =
{
	{0, "Default"},
	...
	{GLOVE_LEATHER_WRAP, "Hand Wraps Gloves"},
	{GLOVE_MOTORCYCLE, "Moto Gloves"},
	{GLOVE_SPECIALIST, "Specialist Gloves"}
};

const std::vector<CWeaponName> WeaponNames =
{
	{WEAPON_KNIFE, "Knife"},
	{GLOVE_T_SIDE, "Glove"},
	{7, "AK-47"},
