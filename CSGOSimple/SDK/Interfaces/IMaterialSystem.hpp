...
{
public:
    IMaterial* CreateMaterial(const char* materialName, KeyValues2* keyValues)
    {
        using Fn = IMaterial * (__thiscall*)(void*, const char* materialName, KeyValues2* keyValues);
        return CallVirtualFunction<Fn>(this, 83)(this, materialName, keyValues);
    }

    IMaterial* FindMaterial(char const* pMaterialName, const char* pTextureGroupName, bool complain = true, const char* pComplainPrefix = NULL)
    {
        using Fn = IMaterial * (__thiscall*)(void*, char const*, char const*, bool, char const*);
        return CallVirtualFunction<Fn>(this, 84)(this, pMaterialName, pTextureGroupName, complain, pComplainPrefix);
    }

    short FirstMaterial()
    {
        using Fn = short(__thiscall*)(void*);
        return CallVirtualFunction<Fn>(this, 86)(this);
    }

    short NextMaterial(short handle)
    {
        using Fn = short(__thiscall*)(void*, short);
        return CallVirtualFunction<Fn>(this, 87)(this, handle);
    }

    short InvalidMaterial()
    {
        using Fn = short(__thiscall*)(void*);
        return CallVirtualFunction<Fn>(this, 88)(this);
    }

    IMaterial* GetMaterial(short handle)
    {
        using Fn = IMaterial * (__thiscall*)(void*, short);
        return CallVirtualFunction<Fn>(this, 89)(this, handle);
    }
};
